...
export default function RemoveDoctorDialog({
  ...
  const removeCondition = api.healthcareProvider.removeDoctor.useMutation();
  ...
  const handleClick = () => {
    removeCondition.mutate(
      ...
      {
        onSuccess: () => {
          toast.success("Doctor was successfully removed.");
          router.refresh();
        },
    ...
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          {/* @ts-expect-error props */}
          <AlertDialogDescription>
            This will permanently remove the doctor from this healhcare
